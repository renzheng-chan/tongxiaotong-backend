...
CREATE TABLE `tb_bank`  (
  ...
  `repay_period` datetime(0) NOT NULL COMMENT '还款期限',
...
CREATE TABLE `tb_bank_user`  (
  `bankuser_account` int(0) NOT NULL COMMENT '银行用户人员唯一id',
  `bankuser_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名',
  ...
  PRIMARY KEY (`bankuser_account`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_product`  (
  ...
  `belong_account` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属账号',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
...
CREATE TABLE `tb_purchase`  (
  `purchase_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '订单id',
...
CREATE TABLE `tb_qa`  (
  ...
  `expert_account` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '专家用户id',
  `questioner_account` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '咨询者id',
...
CREATE TABLE `tb_user`  (
  ...
  `address` int(0) NOT NULL COMMENT '地址',
